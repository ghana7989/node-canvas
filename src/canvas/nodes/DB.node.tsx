...
export default function DBNode({ data, selected, id }: NodeProps<NodeData>) {
    ...
    <>
      ...
      <div
        className={clsx(
          ...
          {
            'bg-blue-600 border-blue-800': selected,
            'bg-blue-700 border-blue-900': !selected,
          },
        )}
      >
        {selected && (
...
// export function DBNestedNode({ data, selected, id }: NodeProps<NodeData>) {
